...
%prep
%setup -q -n pynvim-0.4.0
cd %{_builddir}/pynvim-0.4.0
...
cp %{_builddir}/pynvim-0.4.0/LICENSE %{buildroot}/usr/share/package-licenses/pynvim/e3db89a4bda5ca1013225637c5e6d0716f6587b5
