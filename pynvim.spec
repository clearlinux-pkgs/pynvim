...
Version  : 0.4.1
Release  : 7
URL      : https://github.com/neovim/pynvim/archive/0.4.1/pynvim-0.4.1.tar.gz
Source0  : https://github.com/neovim/pynvim/archive/0.4.1/pynvim-0.4.1.tar.gz
...
%prep
%setup -q -n pynvim-0.4.1
cd %{_builddir}/pynvim-0.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587511879
...
cp %{_builddir}/pynvim-0.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pynvim/e3db89a4bda5ca1013225637c5e6d0716f6587b5
